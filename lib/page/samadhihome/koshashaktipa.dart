...
import 'package:pazir/page/samadhihome/santshodhyub.dart';
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      behavior: HitTestBehavior.translucent,
                      onTap: () {
                        final tysHAmNum = FFAppState.instance
                            .dingingGetUser(FFAppState.instance.flexionLogUid)!
                            .relations
                            .stillsUGood;

                        if (tysHAmNum >= 300) {
                          final paLIyogu = FFAppState.instance.dingingGetUser(
                            FFAppState.instance.flexionLogUid,
                          );
                          if (paLIyogu != null) {
                            final eMbelLisHed = paLIyogu.copyWith(
                              stillsUGood: paLIyogu.relations.stillsUGood - 300,
                            );
