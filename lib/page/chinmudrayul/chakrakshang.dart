...
class ChakRakShang extends StatefulWidget {
  const ChakRakShang({super.key});

  @override
  State<ChakRakShang> createState() => _ChakRakShang();
}

class _ChakRakShang extends State<ChakRakShang> {
  @override
  void initState() {
    super.initState();
  }
                ...
                child: Flex(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      "you want to be seated and turn on the \nmicrophone?",
                      style: TextStyle(
                        fontFamily: 'NotoSans',
                        fontSize: 13,
