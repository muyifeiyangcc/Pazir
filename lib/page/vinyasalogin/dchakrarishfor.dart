...
class DchakRarishFor extends StatefulWidget {
  const DchakRarishFor({super.key});

  @override
  State<DchakRarishFor> createState() => _DchakRarishFor();
}

class _DchakRarishFor extends State<DchakRarishFor> {
  @override
  void initState() {
    super.initState();
  }
